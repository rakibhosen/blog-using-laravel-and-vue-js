      ...
      <div class="container">
        <div class="row">
          ...
          <div class="span6">
            ...
            <div class="flexslider">
              <ul class="slides">
                <li>
                  <img :src="`frontend/img/works/full/image-01-full.jpg`" alt="" />
                </li>
                <li>
                   
                   <img :src="`frontend/img/works/full/image-02-full.jpg`" alt="" />
                </li>
                <li>
                 <img :src="`frontend/img/works/full/image-03-full.jpg`" alt="" />
                </li>
              </ul>
            </div>
            <!-- end flexslider -->
        ...
        <div class="row">
          ...
          <div class="span3">
              ...
              <img :src="`frontend/img/dummies/team1.jpg`" class="img-polaroid" alt="" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
                   <img :src="`frontend/img/dummies/team2.jpg`" class="img-polaroid" alt="" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
                  <img :src="`frontend/img/dummies/team3.jpg`" class="img-polaroid" alt="" />
            <div class="roles">
              <p class="lead">
          ...
          <div class="span3">
                    <img :src="`frontend/img/dummies/team4.jpg`" class="img-polaroid" alt="" />
            <div class="roles">
              <p class="lead">
